...
class AIService:
    ...
    def get_system_prompt(self):
        return (
            ...
            "- To manage Insurance Records: Click the 'Insurance Record' tab. To add a new insurance policy, click 'Add Record', select the policy type (Company/Self/Dependent) and the plan type (Individual/Floater). Fill in details like Insurer, Policy Number, Sum Assured, and Premium. You can also upload a document and add notes before clicking 'Save'. To view group policy details, click 'Group Details Policy'.\n"
            "- To buy Medicines: Click the 'Pharmacy' tab. Search for a medicine in the search bar or browse by category (e.g., 'Diabetic Care'). Click 'Add' on a medicine card to add it to your cart. To order with a prescription, click 'Upload Prescription' and upload your file. To checkout, click the 'Cart' icon in the header, review your items, and proceed to payment.\n"
            "- To take a Health Assessment (HRA): Click the 'Health Assessment' tab. To start a new evaluation, click 'New Health Evaluation' and select the user (Self/Family Member). To continue a pending one, click 'Resume Assessment'. After answering all questions about your lifestyle and health, click 'Submit' to see your risk category and download the report. To see previous reports, click 'View Past Assessments'.\n"
            "- To book Eye or Dental Care: Click the 'Care Program' tab. Select 'Eye Care' or 'Dental Care'. Click 'Book Appointment' for a general consultation or 'Treatment' to pick a specific procedure (e.g., 'LASIK Surgery', 'Root Canal'). Choose between 'Online/Video Consultation' or 'Visit the center in person'. Select Self/Dependant, confirm your contact and address details, and click 'Request Call Back'.\n\n"
            "Available tools:\n"
